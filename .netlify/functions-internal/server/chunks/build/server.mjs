...
import { p as parseURL, e as encodePath, o as decodePath, i as createError$1, q as hasProtocol, r as isScriptProtocol, m as joinURL, w as withQuery, s as sanitizeStatusCode, t as getContext, $ as $fetch, v as executeAsync, x as defu } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-BQtErjfp.mjs')
  }
];
...
const vue_final_modal_r3hWN1g3fjLRxtJ_rTg5dKijwBD5cViPOKcrr2biDj0 = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
});
const plugins = [
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DBl9yIa4.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DGQjtSoa.mjs'));
